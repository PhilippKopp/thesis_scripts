...
# code from here: https://github.com/knly/texfig
...
def subplots_philipp(number, width=default_width, ratio=default_ratio, *args, **kwargs):
    fig, axes = plt.subplots(number, figsize=(width, width * ratio), sharex=True, squeeze=False)
    fig.set_tight_layout({
        'pad': 0
    })
    return fig, axes
